...
class YaUploader:
    ...
    def upload_file_to_disk(self, disk_file_path, path_filename):
        """Метод загруджает файл filename на яндекс диск. disk_file_path -> путь до файла на yandex.disk """
...
if __name__ == '__main__':
    ...
    uploader.upload_file_to_disk(disk_file_path="your_folder_on_yandex_disk/text.txt", path_filename="test.txt")